...
const Semester = ({ navigation }) => {
  ...
  const fetchData = async () => {
    try {
      const response = await api.get('/api/semester/'); // Thay thế your-endpoint bằng đường dẫn API của bạn
  ...
  return (
    <View style={{ flex: 1 }}>
      ...
      <View style={{ width: "100%", height: 50, justifyContent: "center", alignItems: "center", backgroundColor: 'rgba(192,192,192,0.7)' }}>
        <Text style={{ fontSize: 20, fontWeight: 'bold', }}>Học kì</Text>
      </View>
        ...
        <ScrollView style={styles.container}>
          ...
          <View style={styles.table}>
            <View style={styles.headerRow}>
              ...
              <Text style={[styles.headerItem, styles.column2]}>Học kì</Text>
            </View>
